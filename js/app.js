    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
            ...
            .state('app.MonCompte', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/authentication/html/moncompte.html",
                        controller: "moncompteCtrl"
                    }
                }
            })

            .state('app.MesInformationsPerso', {
                url: "/MesInformationsPerso",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/authentication/html/mesinformationsperso.html",
                        controller: "mesinfospersoCtrl"
                    }
                }
            })

            .state('app.PasswordUpdate', {
                url: "/PasswordUpdate",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/authentication/html/passwordupdate.html",
                        controller: "passwordupdateCtrl"
                    }
                }
            })
             .state('app.PaiementPrefere', {
                url: "/PaiementPrefere",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/authentication/html/paiementprefere.html",
                        controller: "paiementprefereCtrl"
                    }
                }
            })

            .state('app.MontantPrefere', {
                url: "/MontantPrefere",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/authentication/html/montantprefere.html",
                        controller: "montantprefereCtrl"
                    }
                }
            })
            .state('app.SignUp', {
            ...
            .state('app.Paiement', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/paiement/html/paiement.html"
                    }
                }
            })
            .state('app.PromesseDon', {
                url: "/PromesseDon",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/paiement/html/promessedon.html"
                    }
                }
            })
            ...
            .state('app.appelUrgence', {
                url: "/appelUrgence",
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence.html"
                    }
                }
            })
            .state('app.appelUrgence1', {
                url: "/appelUrgence1",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence1.html"
                    }
                }
            })
             .state('app.donappelUrgence1', {
                url: "/donappelUrgence1",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence1don.html"
                    }
                }
            })
            .state('app.appelUrgence2', {
                url: "/appelUrgence2",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence2.html"
                    }
                }
            })
             .state('app.donappelUrgence2', {
                url: "/donappelUrgence2",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence2don.html"
                    }
                }
            })
            .state('app.appelUrgence3', {
                url: "/appelUrgence3",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence3.html"
                    }
                }
            })
             .state('app.donappelUrgence3', {
                url: "/donappelUrgence3",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence3don.html"
                    }
                }
            })
            .state('app.appelUrgence4', {
                url: "/appelUrgence4",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence4.html"
                    }
                }
            })
             .state('app.donappelUrgence4', {
                url: "/donappelUrgence4",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence4don.html"
                    }
                }
            })
            .state('app.appelUrgence5', {
                url: "/appelUrgence5",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence5.html"
                    }
                }
            })
             .state('app.donappelUrgence5', {
                url: "/donappelUrgence5",
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/appelurgence/html/appelurgence5don.html"
                    }
                }
            })
            .state('app.cubeFeed', {
